...
def get_properties():
    ...
    properties_dict = {
        ...
        "-moz-binding": ["none"],
        "-moz-border-bottom-colors": ["none", "<color>"],
        "-moz-border-left-colors": ["none", "<color>"],
        "-moz-border-right-colors": ["none", "<color>"],
        "-moz-border-top-colors": ["none", "<color>"],
        "-moz-box-flexgroup": [],
        ...
        "-moz-orient": ["block", "horizontal", "inline", "vertical"],
        "-moz-outline-radius": ["<calc>"],
        "-moz-outline-radius-bottomleft": ["<calc>"],
        "-moz-outline-radius-bottomright": ["<calc>"],
        "-moz-outline-radius-topleft": ["<calc>"],
        "-moz-outline-radius-topright": ["<calc>"],
        "-moz-stack-sizing": ["ignore", "stretch-to-fit"],
        "-moz-text-blink": ["blink", "none"],
        "-moz-user-focus": [
            "ignore",
            "none",
            "normal",
        ...
        "-moz-user-input": ["auto", "disabled", "enabled", "none"],
        "-moz-user-modify": ["read-only", "read-write", "write-only"],
        "-moz-window-dragging": ["drag", "no-drag"],
        "-moz-window-shadow": ["default", "menu", "none", "sheet", "tooltip"],
        "-ms-accelerator": ["false", "true"],
        "-ms-block-progression": ["bt", "lr", "rl", "tb"],
        "-ms-content-zoom-chaining": ["chained", "none"],
        "-ms-content-zoom-limit": ["<calc>"],
        "-ms-content-zoom-limit-max": ["<calc>"],
        "-ms-content-zoom-limit-min": ["<calc>"],
        "-ms-content-zoom-snap": ["<snap>", "mandatory", "none", "proximity"],
        "-ms-content-zoom-snap-points": ["<snap>"],
        ...
        "-ms-grid-column-span": ["<calc>"],
        "-ms-grid-columns": ["none", "<calc>"],
        "-ms-grid-layer": [],
        "-ms-grid-row-align": ["center", "end", "start", "stretch"],
        "-ms-grid-row-span": ["<calc>"],
        "-ms-grid-rows": ["none", "<calc>"],
        "-ms-high-contrast-adjust": ["auto", "none"],
        "-ms-hyphenate-limit-chars": ["auto", "<calc>"],
        "-ms-hyphenate-limit-lines": ["no-limit", "<calc>"],
        "-ms-hyphenate-limit-zone": [],
        "-ms-ime-align": ["after", "auto"],
        ...
        "-ms-overflow-style": ["-ms-autohiding-scrollbar", "auto", "none", "scrollbar"],
        ...
        "-ms-scroll-snap-x": ["<snap>", "mandatory", "none", "proximity"],
        "-ms-scroll-snap-y": ["<snap>", "mandatory", "none", "proximity"],
        ...
        "-webkit-border-before-width": ["<border-width>", "<calc>"],
        ...
        "-webkit-mask-position-x": ["center", "left", "right"],
        "-webkit-mask-position-y": ["bottom", "center", "top"],
        "-webkit-mask-repeat-x": ["no-repeat", "repeat", "round", "space"],
        "-webkit-mask-repeat-y": ["no-repeat", "repeat", "round", "space"],
