...
..  ^ text.restructuredtext.embedded.css source.css.embedded.restructuredtext
...
..      ^ text.restructuredtext.embedded.html text.html.basic.embedded.restructuredtext
...
.. raw:: javascript
   this.func()
..            ^ text.restructuredtext.embedded.javascript source.javascript.embedded.restructuredtext
...
.. raw:: json
   { "one": 1, "two": 2 }
..                       ^ text.restructuredtext.embedded.json source.json.embedded.restructuredtext
...
.. raw:: python
    ...
    print("Hello, world!")
..                        ^ text.restructuredtext.embedded.python source.python.embedded.restructuredtext

.. raw:: toml
   table = { key = "value" }
..                          ^ text.restructuredtext.embedded.toml source.toml.embedded.restructuredtext

.. raw:: yaml
   one:
     two: 'three'
..               ^ text.restructuredtext.embedded.yaml source.yaml.embedded.restructuredtext
...
Test    simplenamed_ Test

Test    `phrase named`_ Test

Test    `Syntax docs <https://www.sublimetext.com/docs/syntax.html>`_ Test

Test    `link <Syntax docs_>`_ Test

.. with two underscores: anonymous

Test    simpleanonymous__ Test

Test    `phrase anonymous`__ Test
