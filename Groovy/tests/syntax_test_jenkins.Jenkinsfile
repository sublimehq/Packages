...
// <- source.groovy comment.line.double-slash punctuation.definition.comment
...
//           ^ meta.structure punctuation.definition.structure.begin
...
// <- meta.structure punctuation.definition.structure.end
//^ - meta.structure
