...
%   ^ meta.function.newcommand.latex
%          ^^^^ support.function.latex entity.name.newcommand.latex
%              ^^^^^^ meta.function.definition.latex - meta.function.newcommand.latex
%                 ^ support.function.general.latex
...
%   ^ meta.function.declare-math-operator.latex
%                    ^^^ support.function.latex entity.name.declare-math-operator.latex
%                            ^ text.tex.latex
...
% Here, we check that opening an environment within a command defintition does not
