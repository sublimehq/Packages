...
%^^^^^^^^ keyword.declaration.register.tex
...
\newdimen % any whitespace and comments are allowed here
...
\newcount % any whitespace and comments are allowed here

  { \mycounter }
% ^^^^^^^^^^^^^^ meta.register.tex meta.group.brace.tex
%   ^^^^^^^^^^ entity.name.constant.tex
% ^ punctuation.definition.group.brace.begin.tex
%   ^ punctuation.definition.backslash.tex
%              ^ punctuation.definition.group.brace.end.tex
