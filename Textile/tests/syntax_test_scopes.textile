...
<!--       ^^^^^^^^^^ meta.embedded.text.plain text.plain                    -->
<!--                  ^^ punctuation.definition.notextile.end                -->

Test

Test    <notextile>plain text</notextile>                                   Test
<!--    ^^^^^^^^^^^ punctuation.section.notextile.begin meta.tag.other.html  -->
<!--    ^ punctuation.definition.tag.begin.html                              -->
<!--              ^ punctuation.definition.tag.end.html                      -->
<!--               ^^^^^^^^^^ meta.embedded.text.plain text.plain            -->
<!--                         ^^^^^^^^^^^^ punctuation.section.notextile.end meta.tag.other.html -->
<!--                         ^^ punctuation.definition.tag.begin.html        -->
<!--                                    ^ punctuation.definition.tag.end.html -->
